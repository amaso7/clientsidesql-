...
class App extends Component {
  ...
  renderPt = ({ID, firstname, lastname, dob, provider, prevappt, nextappt, meds, num, msg }) => <ul key = {ID}> ID number:{ID}, Name:{firstname} {lastname},Date of Birth: {dob} Provider:{provider}, Previous Appointment: {prevappt}, Next Appointment: {nextappt}, Medication:  {meds}, Phonenumber:  {num}, Message: {msg}</ul>
